...
1. 在虛擬機器中，透過在搜尋列中搜尋 **PowerShell**，並在找到時以滑鼠右鍵按一下 **Windows PowerShell** 以便**以系統管理員身分執行**，來啟動 PowerShell。
...
3. 完成後，將出現一個提示，說明 [**成功**] 的值為 **True**。您無需重新啟動虛擬機器即可完成安裝。按一下虛擬機器頂部中間藍色條上的 **x**，關閉與 VM 的 RDP 連線。 
